...
- Access to operator API for Merkle proofs. The CLI defaults to `https://ncn-governance.solana.com`.
...
<Callout type="info">
  The `operator-api-url` config key defaults to `https://ncn-governance.solana.com` for override commands. Override it only if you need a different verifier/router.
</Callout>
