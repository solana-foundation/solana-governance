...
| `--snapshot-slot-offset` | i64 | May be negative; maximum 414,000 to preserve the NCN consensus window |

<Callout type="info">
  Out-of-bounds values are rejected client-side before sending and on-chain, including snapshot offsets above 414,000 slots.
</Callout>
