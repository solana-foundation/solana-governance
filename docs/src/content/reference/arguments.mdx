...
| `operator-api-url` | Verifier service URL for proof fetching. Defaults to `https://ncn-governance.solana.com`; override only if you run a different verifier/router. |
