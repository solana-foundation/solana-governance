...
| `VotingExpired` | Voting window has closed (at or after `vote_expiry_slot`) |
...
| `UnauthorizedProposalUpdate` | Only the original proposal author may update the proposal document |
