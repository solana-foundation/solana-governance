...
| `reserved` | `[u8; 8]` | Reserved legacy storage; not configurable |
...
| `vote_expiry_slot` | `u64` | Slot when NCN voting closes |
...
| `vote_expiry_slot: u64` | Must be at least 18,000 slots after `snapshot_slot` |
