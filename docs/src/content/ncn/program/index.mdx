...
**Program ID:** `HsiPGfvF441TrU8eCLLerQDcEMtyzYszBfKxqoSuaD9R`
...
<Callout>
  The `proposal` account must be a PDA from the `svmgov` program (`4HarXuo8QjE5GSGzuUxHA1cnNM9mFt2th2JQAC5DSNqU`). Compile with `skip-pda-check` feature to disable this check for testing.
</Callout>
