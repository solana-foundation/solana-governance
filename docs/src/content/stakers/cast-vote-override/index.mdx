...
See [cast_vote_override.rs](https://github.com/3uild-3thos/svmgov_program/blob/main/contract/programs/svmgov_program/src/instructions/cast_vote_override.rs) in the program.
